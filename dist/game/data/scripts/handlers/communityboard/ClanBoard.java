	...
	public boolean parseCommunityBoardCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("_bbsclan_clanlist"))
		{
			...
			else if (command.startsWith("_bbsclan_clanlist;"))
			{
				...
				{
					clanList(activeChar, 1);
					LOG.warn("{}: Player {} send invalid clan list bypass {}!", ClanBoard.class.getSimpleName(), activeChar, command);
				}
			}
		}
		else if (command.startsWith("_bbsclan_clanhome"))
		{
			...
			else if (command.startsWith("_bbsclan_clanhome;"))
			{
				...
				{
					clanHome(activeChar);
					LOG.warn("{}: Player {} send invalid clan home bypass {}!", ClanBoard.class.getSimpleName(), activeChar, command);
				}
			}
		}
