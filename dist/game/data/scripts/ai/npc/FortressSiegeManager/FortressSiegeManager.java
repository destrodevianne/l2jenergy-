		...
		switch (event)
		{
			...
			case "register":
			{
				...
				else
				{
					...
					else if ((clan.getLevel() < FortSiegeConfig.SIEGE_CLAN_MIN_LEVEL))
					{
					...
					else if ((clan.getCastleId() != 0) && (clan.getCastleId() != castle.getResidenceId()) && FortSiegeConfig.JUST_TO_TERRITORY)
					{
