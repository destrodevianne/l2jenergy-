...
public final class WarriorFishingBlock extends AbstractNpcAI
{
		...
		switch (event)
		{
			case "SPAWN":
			{
				...
				else
				{
					...
					broadcastNpcSay(npc, ChatType.NPC_ALL, NPC_STRINGS_ON_SPAWN[getRandom(NPC_STRINGS_ON_SPAWN.length)], target.getName());
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon)
	{
		...
		{
			broadcastNpcSay(npc, ChatType.NPC_ALL, NPC_STRINGS_ON_ATTACK[getRandom(NPC_STRINGS_ON_ATTACK.length)]);
		}
	...
	{
		broadcastNpcSay(npc, ChatType.NPC_ALL, NPC_STRINGS_ON_KILL[getRandom(NPC_STRINGS_ON_KILL.length)]);
