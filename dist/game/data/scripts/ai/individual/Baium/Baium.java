...
public final class Baium extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		switch (event)
		{
			...
			case "RESPAWN_BAIUM":
			{
				...
				{
					player.sendMessage(MessagesData.getInstance().getMessage(player, getClass().getSimpleName() + "dp_ia_baium_no_respawn"));
				}
				break;
			}
			case "ABORT_FIGHT":
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		if (zone.isCharacterInZone(killer))
		{
			...
			long respawnTime = (GrandBossConfig.BAIUM_SPAWN_INTERVAL + getRandom(-GrandBossConfig.BAIUM_SPAWN_RANDOM, GrandBossConfig.BAIUM_SPAWN_RANDOM)) * 3600000;
