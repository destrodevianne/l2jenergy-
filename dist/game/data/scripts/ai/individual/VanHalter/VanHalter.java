...
{
	private static final int TRIOLS_TELE = 32058;
	private static final int TRIOLS_REVELATION = 32068;
	...
	private VanHalter()
	{
		...
		addStartNpc(TRIOLS_REVELATION, TRIOLS_TELE);
		addFirstTalkId(TRIOLS_REVELATION, TRIOLS_TELE);
		addTalkId(TRIOLS_REVELATION, TRIOLS_TELE);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		switch (npc.getId())
		{
			...
			case VAN_HALTER:
				startRespawn();
				addSpawn(TRIOLS_TELE, VAN_HALTER_LOC, false, 300000);
				break;
		}
