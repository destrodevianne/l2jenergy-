		...
		switch (event)
		{
			...
			case "accept":
			{
				...
				else
				{
					...
					player.sendMessage(MessagesData.getInstance().getMessage(player, "dp_wedding_married"));
					player.setMarried(true);
					player.setMarryRequest(false);
					partner.sendMessage(MessagesData.getInstance().getMessage(player, "dp_wedding_married"));
			...
			case "decline":
			{
				...
				player.sendMessage(MessagesData.getInstance().getMessage(player, "dp_wedding_declined"));
				partner.sendMessage(MessagesData.getInstance().getMessage(player, "dp_wedding_declined_notice"));
