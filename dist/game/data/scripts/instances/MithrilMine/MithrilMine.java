...
public final class MithrilMine extends AbstractInstance
{
			...
			case "FINISH":
			{
				for (L2Character knownChar : npc.getKnownList().getKnownCharacters())
				{
					if ((knownChar != null) && (knownChar.getId() == KEGOR))
					{
						...
						broadcastNpcSay(kegor, ChatType.NPC_ALL, NpcStringId.I_CAN_FINALLY_TAKE_A_BREATHER_BY_THE_WAY_WHO_ARE_YOU_HMM_I_THINK_I_KNOW_WHO_SENT_YOU);
					}
				}
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if (npc.getId() == KEGOR)
		{
			broadcastNpcSay(npc, ChatType.NPC_ALL, NpcStringId.HOW_COULD_I_FALL_IN_A_PLACE_LIKE_THIS);
