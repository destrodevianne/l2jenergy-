...
public class Q00114_ResurrectionOfAnOldManager extends Quest
{
		...
		switch (event)
		{
			...
			case "32047-15b.html":
				if ((golem == null) || ((golem != null) && golem.isDead()))
				{
					...
					golem.broadcastPacket(new NpcSay(golem.getObjectId(), ChatType.NPC_ALL, golem.getId(), NpcStringId.YOU_S1_YOU_ATTACKED_WENDY_PREPARE_TO_DIE).addStringParameter(player.getName()));
					golem.setRunning();
			...
			case "golem_despawn":
				st.unset("spawned");
				golem.broadcastPacket(new NpcSay(golem.getObjectId(), ChatType.NPC_ALL, golem.getId(), NpcStringId.S1_YOUR_ENEMY_WAS_DRIVEN_OUT_I_WILL_NOW_WITHDRAW_AND_AWAIT_YOUR_NEXT_COMMAND).addStringParameter(player.getName()));
				golem.deleteMe();
				golem = null;
				htmltext = null;
				break;
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		{
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), ChatType.NPC_ALL, npc.getId(), NpcStringId.THIS_ENEMY_IS_FAR_TOO_POWERFUL_FOR_ME_TO_FIGHT_I_MUST_WITHDRAW));
			st.setCond(11, true);
			st.unset("spawned");
