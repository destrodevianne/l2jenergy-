...
public class Q00615_MagicalPowerOfFirePart1 extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "open_box":
				...
				break;
			case "eye_despawn":
				npc.broadcastPacket(new NpcSay(npc, ChatType.NPC_ALL, NpcStringId.ASEFA_HAS_ALREADY_SEEN_YOUR_FACE));
				npc.deleteMe();
				break;
		}
		return htmltext;
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon)
	{
		...
		if ((st != null) && st.isCond(2) && !st.isSet("spawned"))
		{
			...
			eye.broadcastPacket(new NpcSay(eye, ChatType.NPC_ALL, NpcStringId.YOU_CANT_AVOID_THE_EYES_OF_ASEFA));
