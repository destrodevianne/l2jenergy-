...
public final class Q00196_SevenSignsSealOfTheEmperor extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			isBusy = false;
			npc.broadcastPacket(new NpcSay(npc.getObjectId(), ChatType.NPC_ALL, npc.getId(), NpcStringId.THE_ANCIENT_PROMISE_TO_THE_EMPEROR_HAS_BEEN_FULFILLED));
			npc.deleteMe();
			...
			case "ssq_mammon":
			{
				if (st.isCond(1))
				{
					if (!isBusy)
					{
						...
						merchant.broadcastPacket(new NpcSay(merchant.getObjectId(), ChatType.NPC_ALL, merchant.getId(), NpcStringId.WHO_DARES_SUMMON_THE_MERCHANT_OF_MAMMON));
