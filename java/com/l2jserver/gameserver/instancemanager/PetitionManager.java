...
public final class PetitionManager
{
	...
	public void clearCompletedPetitions()
	{
		...
		LOG.info("{}: Completed petition data cleared. {} petition(s) removed.", getClass().getSimpleName(), numPetitions);
	}
	...
	public void clearPendingPetitions()
	{
		...
		LOG.info("{}: Pending petition queue cleared. {} petition(s) removed.", getClass().getSimpleName(), numPetitions);
	}
