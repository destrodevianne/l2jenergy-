...
{
	private static Logger LOG = LoggerFactory.getLogger(DimensionalRiftManager.class);
	...
	private void loadRooms()
	{
		...
		LOG.info("{}: Loaded {} room types with {} rooms.", getClass().getSimpleName(), typeSize, roomSize);
	}
	...
	public void loadSpawns()
	{
		...
		LOG.info("{}: Loaded {} dimensional rift spawns, {} errors.", getClass().getSimpleName(), countGood, countBad);
	}
	...
	public synchronized void start(L2PcInstance player, byte type, L2Npc npc)
	{
		...
		{
			player.sendMessage(MessagesData.getInstance().getMessage(player, "dimensional_rift_full"));
			return;
		}
