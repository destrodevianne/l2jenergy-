...
public class GeneralConfig
{
	...
	@Setting(name = "ListOfProtectedItems", method = "listOfprotected", splitter = ",")
	...
	@Setting(name = "GlobalChat", method = "globalchat")
	public static String DEFAULT_GLOBAL_CHAT;
	@Setting(name = "TradeChat", method = "tradechat")
	...
	@Setting(name = "AltBirthdayMailSubject")
	public static String ALT_BIRTHDAY_MAIL_SUBJECT;
	@Setting(name = "AltBirthdayMailText")
	...
	public void globalchat(final String value)
	{
		DEFAULT_GLOBAL_CHAT = value;
	}
	
	public void tradechat(final String value)
	{
	...
	{
		LIST_PROTECTED_ITEMS = new ArrayList<>(value.length);
		for (String id : value)
		{
