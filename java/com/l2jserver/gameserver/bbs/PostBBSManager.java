...
public class PostBBSManager extends BaseBBSManager
{
	...
	{
		List<Post> posts = _postByTopic.get(topic);
		if (posts == null)
		{
			posts = DAOFactory.getInstance().getPostDAO().load(topic);
	...
	{
		final List<Post> posts = getGPosttByTopic(topic);
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2PcInstance activeChar)
	{
		...
		else
		{
			...
			{
				final List<Post> posts = getGPosttByTopic(t);
				if (!posts.isEmpty())
				{
					...
					{
						post.setTxt(ar4);
						DAOFactory.getInstance().getPostDAO().update(post);
