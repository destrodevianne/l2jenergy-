...
{
	protected static final Logger LOG = LoggerFactory.getLogger(QuestState.class);
	...
	public String set(String var, String val)
	{
		...
		if ("cond".equals(var))
		{
			...
			{
				LOG.warn("{}, {} cond [{}] is not an integer.  Value stored, but no packet was sent!", _player.getName(), getQuestName(), val, e);
			}
		}
		return val;
	}
	...
	public final void saveGlobalQuestVar(String var, String value)
	{
		...
		{
			LOG.warn("Could not insert player's global quest variable!", e);
		}
	}
	...
	public final String getGlobalQuestVar(String var)
	{
		...
		{
			LOG.warn("Could not load player's global quest variable!", e);
		}
		return result;
	}
	...
	public final void deleteGlobalQuestVar(String var)
	{
		...
		{
			LOG.warn("Could not delete player's global quest variable; charId = {}, variable name = {}. Exception!", _player.getObjectId(), var, e);
		}
	}
	...
	public int getInt(String var)
	{
		...
		{
			LOG.info("Quest {}, method getInt({}), tried to parse a non-integer value ({}). Char Id: {}", getQuestName(), var, variable, _player.getObjectId(), nfe);
		}
		return varint;
	}
